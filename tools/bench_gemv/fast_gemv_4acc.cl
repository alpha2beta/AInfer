...
__kernel void int4_gemv_m1(
    ...
    for (int g = 0; g < num_groups; ++g) {
        ...
        __global const uchar16 *w_vec16 = (__global const uchar16 *)(row_w + g * (GROUP_SIZE / 2));
        ...
        for (int v = 0; v < 4; ++v) {
            ...
            acc2 += (float)n16 * x2.s0 + (float)n17 * x2.s1
